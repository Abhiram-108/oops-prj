...
// #include "logo.cpp"
using namespace std;
vector<string> oper = {"Simple Calculator","Matrices","statistics","vectorrs","mensuration","polynomials","Finding solutions","Complex","Finding roots"};
...
// vector<string> arr2 = {"Polynomial Addition","LinearPolynomialSolver","QuadraticPolynomialSolver","PolynomialEquationSolver","Back"};
...
// void printmatches(int line_ct,vector<string> &v)
// {
...
void select_Mensuration_operation(){
    ...
    print_multi_sbar(2,arr1[x]);
     ...
     if(x==0){
        ...
        cout<<" ENTER THE LENGHT ANS BREDTH VALUES:"<<endl;
        cin>>length>>bredth;
     ...
     else if(x==1)
    {
        ...
        ascii_triangle();
        double a,b,c;
        cout<<"ENTER THE THREE SIDE VALUES OF A TRIANGLE:"<<endl;
        cin>>a>>b>>c;
        Triangle tri(a,b,c);
        cout<<"Triangle:\n"<<tri<<endl;
    }
        ...
        ascii_rhombus();
        double a,b,c;
        cout<<" ENTER THE SIDE VALUE AND TWO DIAOGNAL VALUES CONECUTIVELY:"<<endl;
        cin>>a>>b>>c;
        Rhombus rho(a,b,c);
        cout<<"Rhombus:\n"<<rho<<endl;
    }
        ...
        ascii_cone();
        double a,b;
        cout<<"ENTER THE HEIGHT VALUE AND RADIUS VALUE CONSECUTIVELY:"<<endl;
        cin>>a>>b;
        Cone co(a,b);
        cout<<"Cone:\n"<<co<<endl;
        ...
        ascii_cuboid();
        double a,b,c;
        cout<<"ENTER THE LENGTH,BREDTH,HEIGHT VALUES CONSECUTIVELY:"<<endl;
        cin>>a>>b>>c;
        Cuboid cub(a,b,c);
        cout<<"Cuboid:\n"<<cub<<endl;
    }
        ...
        ascii_cylinder();
        double a,b;
        cout<<"ENTER THE HEIGHT AND RADIUS VALUE CONSECUTIVELY:"<<endl;
        cin>>a>>b;
        Cylinder cy(a,b);
        cout<<" Cylinder:\n"<<cy<<endl;
        ...
        ascii_trapezium();
        double a,b,c,d,e;
        cout<<"ENTER THE HEIGHT AND FOUR SIDES CONSECUTIVELY:"<<endl;
        cin>>a>>b>>c>>d>>e;
...
// Derived class for polynomial addition
...
// Derived class for polynomial subtraction
...
// Derived class for polynomial multiplication
...
void select_complex_operations()
{
    int scalar;
    cout << "\t\t\t"
         << "Avaliable Complex-Number Operations"
         << "\n";
   ...
   print_multi_sbar(2,complexnumber[choice]);
    ...
    {
        cout << endl
             << "Enter ComplexNumber " << i + 1 << " Details : ";
        int a, b;
        cout << endl
             << "Enter Real part : ";
        cin >> a;
    ...
    else if (choice == 7)
    {
        ...
        cout << endl
             << "Polar Form: " << polarR << "(cos(" << polarTheta << ") + i sin(" << polarTheta << "))" << endl;
    }
    else if (choice == 8)
    {
        cout << endl
...
public:
    Calculator() {
        cout << "Enter expression (e.g., sin 45 + cos 90 * tan 30): ";
...

{
    ...
    // vector<string> oper = {"Simple Calculator","Matrices","statistics","vectorrs","mensuration","polynomials","Equation solver","Complex"};
void select_main_operation(){
    // print_sbar("SELECT ONE");
